...
package com.grace.www.qrcode.app;
...
import com.grace.www.qrcode.decode.BeepManager;
import com.grace.www.qrcode.decode.CaptureActivityHandler;
import com.grace.www.qrcode.decode.DecodeFormatManager;
import com.grace.www.qrcode.decode.FinishListener;
import com.grace.www.qrcode.decode.InactivityTimer;
import com.grace.www.qrcode.decode.Intents;
import com.grace.www.qrcode.util.Util;
import com.grace.www.qrcode.view.ViewfinderView;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public static final String RESULT_ALBUM_DATA = "result_album_data";
    ...
    private OnClickListener click = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (id == R.id.button_back) {
                ...
                // TODO: 2018/7/6   打开手机中的相册
                openAlbumForPicUri(REQUEST_CODE);
            } else if (id == R.id.qrcode_btn) {

                Bitmap b = Util.createQRCode("dfjlkglkdj选择二维码图片");
                // TODO: 2018/7/6   拿到bitmap 跳转到生成二维码页面
...
//                finish();
     ...
     * @param requestCode
     */
    private void openAlbumForPicUri(int requestCode) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // TODO: 2018/7/6  这里处理的是打开相册，选中照片后的回调，不是摄像头扫描二维码的结果哟
//        摄像头扫描二维码的结果见：CaptureActivityHandler第90行（这里的代码不需要修改）
        if (resultCode == RESULT_OK) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    Result result = Util.scanningImage(CaptureActivity.this, uri);
                    if (result == null) {
                        Looper.prepare();
                        Toast.makeText(getApplicationContext(), "未识别出二维码，可能二维码太小了", Toast.LENGTH_SHORT).show();
                        Looper.loop();
                    } else {
                        // 数据返回，在这里去处理扫码结果
                        String recode = (result.toString());
                        Intent data = new Intent();
                        data.putExtra(RESULT_ALBUM_DATA, recode);
                        setResult(ALBUM_RESULT_CODE, data);
                        Log.e("qwe", recode);
                        finish();
                    }
                }
