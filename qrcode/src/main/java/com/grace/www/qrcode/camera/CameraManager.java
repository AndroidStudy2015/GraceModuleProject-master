...
package com.grace.www.qrcode.camera;
...
import com.grace.www.qrcode.app.PreferencesActivity;
import com.grace.www.qrcode.config.Config;
import com.grace.www.qrcode.decode.PlanarYUVLuminanceSource;
...
public final class CameraManager {
    ...
    // TODO: 2018/7/6 在这里修改扫描范围
    /**
     * 定义扫描框宽高
     */

    private static final int MIN_FRAME_WIDTH = Config.MIN_FRAME_WIDTH;
    private static final int MIN_FRAME_HEIGHT = Config.MIN_FRAME_HEIGHT;
    private static final int MAX_FRAME_WIDTH = Config.MAX_FRAME_WIDTH;
    private static final int MAX_FRAME_HEIGHT = Config.MAX_FRAME_HEIGHT;

    /**
     * 扫描框距左边的距离，取值为2时，水平方向居中,大于2，靠左
     */
    private float leftOffsetRatio=Config.LEFT_OFFSIDE_RATIO;
    /**
     * 扫描框距顶部的距离，取值为2时，竖直方向居中，大于2，靠上
     */
    private float topOffsetRatio=Config.TOP_OFFSIDE_RATIO;
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            int leftOffset = (int) ((screenResolution.x - width) / leftOffsetRatio);
            int topOffset = (int) ((screenResolution.y - height) / topOffsetRatio);
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
        ...
        switch (previewFormat) {
            ...
            case PixelFormat.YCbCr_422_SP:
                ...
                if (Config.isFullScreenShot) {
                    //                  扩大扫描范围，解决近距离扫码不识别问题，但是感觉没什么大用
